...
export default function SummaryPage() {
  ...
  const generateExecutiveSummary = async (
    conversationData: ConversationSession,
  ) => {
    try {
      ...
      setExecutiveSummary({
        overallAssessment:
          "Your boardroom conversation provided valuable insights. The board members offered constructive feedback to help refine your strategy.",
        keyRisks: [
          "Market validation needs attention",
          "Financial planning requires more detail",
          "Operational scalability should be addressed",
        ],
        keyOpportunities: [
  ...
  const getConversationStats = () => {
    ...
    const boardMessages = conversation.messages.filter(
      (msg) => msg.type === "board_member",
    ).length;
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Comprehensive analysis and recommendations from your boardroom
            conversation
            {conversation.strategy.projectName && (
              <> about &quot;{conversation.strategy.projectName}&quot;</>
            )}
          </p>
        </div>
          ...
          {generatingSummary ? (
            <div className="bg-gray-50 rounded-lg p-6 text-center">
              ...
              <p className="text-gray-600">
                Generating executive summary from your conversation...
              </p>
            </div>
        ...
        {executiveSummary?.conversationHighlights &&
          executiveSummary.conversationHighlights.length > 0 && (
            <div className="bg-white rounded-xl shadow-lg border p-8 mb-8">
              ...
              <ul className="space-y-3">
                {executiveSummary.conversationHighlights.map(
                  (highlight, index) => (
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-8">
          ...
          {/* Key Opportunities */}
          {executiveSummary?.keyOpportunities &&
            executiveSummary.keyOpportunities.length > 0 && (
              <div className="bg-white rounded-xl shadow-lg border p-8">
                <div className="flex items-center gap-2 mb-6">
                ...
                <ul className="space-y-3">
                  {executiveSummary.keyOpportunities.map(
                    (opportunity, index) => (
                      <li key={index} className="flex items-start gap-3">
        ...
        <div className="bg-white rounded-xl shadow-lg border p-8 mb-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              {Object.values(conversation.strategy).filter(
                (value) =>
                  value && typeof value === "string" && value.trim().length > 0,
              ).length === 0 && (
                <div className="text-center text-gray-500 py-8">
                  <p>
                    Strategy details were discussed during the conversation.
                  </p>
                  <p className="text-sm mt-1">
                    View the full conversation for more information.
                  </p>
                </div>
              )}
            </div>
