...
export async function generateMetadata({ params }: PageProps) {
  ...
  description: `Continue your boardroom discussion about ${projectName} with our advisors.`,
    };
  } catch (error) {
    return {
      title: 'Conversation - Simulated Boardroom',
  description: 'Continue your boardroom discussion with our advisors.'
    };
  }
}
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50">
        <Suspense fallback={
          ...
          <ConversationPage sessionId={sessionId} initialConversation={conversation} />
        </Suspense>
      </div>
    );
  } catch (error) {
